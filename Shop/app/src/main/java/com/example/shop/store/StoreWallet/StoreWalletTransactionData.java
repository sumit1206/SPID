...
public class StoreWalletTransactionData {
    ...
    public StoreWalletTransactionData(String walletTransaction_id, int walletTransactionMethod, String walletMoneyAddStatus, String walletMoneyAddTimeStamp, String walletMoneyAmount) {
