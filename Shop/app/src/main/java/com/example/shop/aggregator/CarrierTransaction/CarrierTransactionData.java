...
public class CarrierTransactionData
{
    ...
    public CarrierTransactionData (String parcel_id, int parcelImage, String description, String parcelType, String timeStampStock) {
