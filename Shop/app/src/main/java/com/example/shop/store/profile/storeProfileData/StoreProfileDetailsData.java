package com.example.shop.store.profile.storeProfileData;

import java.io.Serializable;

public class StoreProfileDetailsData implements Serializable {
    ...
    public StoreProfileDetailsData(String profileFieldValue, String profileFieldName, int itemThumbnail, String tableAttribute) {
