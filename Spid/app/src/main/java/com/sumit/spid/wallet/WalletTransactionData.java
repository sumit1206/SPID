...
public class WalletTransactionData {
    ...
    public WalletTransactionData(String walletTransaction_id, int walletTransactionMethod, String walletMoneyAddStatus, String walletMoneyAddTimeStamp, String walletMoneyAmount) {
